...
public class SummaryIntegrationTest {
    ...
    void testSummaryEndpointMultipleTradesToday() throws Exception {
        ...
        mockMvc.perform(get(SUMMARY_ENDPOINT).param("traderId", "testTrader"))
                ...
                .andExpect(jsonPath("$.historicalComparisons[*].tradeCount").value(1)); // There is only one trade for
                                                                                        // yesterday.
    }
    ...
    void testSummaryEndpointEmptyHistoricalComparisons() throws Exception {
        ...
        mockMvc.perform(get(SUMMARY_ENDPOINT).param("traderId", "testTrader"))
                ...
                .andExpect(jsonPath("$.historicalComparisons[0].tradeCount").value(0));// I've changed this assertion
                                                                                       // after test faied, to expect a
                                                                                       // zeroed summary object in
                                                                                       // historicalComparisons, rather
                                                                                       // than an empty array.
