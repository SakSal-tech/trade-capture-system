...
public class UserPrivilegeIntegrationTest {
    ...
    void testTradeEditRoleAllowedPatch() throws Exception {
        ...
        mockMvc.perform(org.springframework.test.web.servlet.request.MockMvcRequestBuilders.patch("/api/trades/1")
                .contentType("application/json")
                .content("{\"tradeId\":1}"))
                .andExpect(status().isOk());
    }
    ...
    void testTradeDeleteRoleAllowed() throws Exception {
        ...
        mockMvc.perform(org.springframework.test.web.servlet.request.MockMvcRequestBuilders.delete("/api/trades/1"))
