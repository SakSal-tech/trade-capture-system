...
INSERT INTO application_user (id, first_name, last_name, login_id, password, active, user_profile_id, version, last_modified_timestamp) VALUES
    ...
    (1002, 'Simon', 'King', 'simon', 'password', true, 1000, 1, '2025-06-02T00:00:00'),
    (1003, 'Ashley', 'Lovegood', 'ashley', 'password', true, 1003, 1, '2025-06-02T00:00:00'),
    (1004, 'Joey', 'Tribbiani', 'joey', 'password', true, 1000, 1, '2025-06-02T00:00:00'),
    (1005, 'Stuart', 'McGill', 'stuart', 'password', true, 1004, 1, '2025-06-02T00:00:00');
