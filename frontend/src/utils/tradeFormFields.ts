...
export const TRADE_FIELDS = [
  ...
  { key: "version", label: "Version", type: "input" },
  {
    ...
    label: "Book",
    type: "dropdown",
    options: () => staticStore.bookValues ?? [],
  },
  {
  ...
  // Use numeric IDs for trader/inputter so the backend receives the
  // expected Long id fields (`traderUserId` / `tradeInputterUserId`).
  // `staticStore.userValues` is an array of { value, label } objects so
  // the dropdown will supply the id as the selected value.
  {
    key: "traderUserId",
    label: "Trader",
    type: "dropdown",
    options: () => staticStore.userValues ?? [],
  },
  {
    key: "tradeInputterUserId",
    label: "Inputter",
    type: "dropdown",
    options: () => staticStore.userValues ?? [],
  },
  {
    ...
    label: "Trade Type",
    type: "dropdown",
    options: () => staticStore.tradeTypeValues ?? [],
  },
  {
    key: "tradeSubType",
    label: "Trade Sub Type",
    type: "dropdown",
    options: () => staticStore.tradeSubTypeValues ?? [],
  },
  {
    key: "tradeStatus",
    label: "Trade Status",
    type: "dropdown",
    options: () => staticStore.tradeStatusValues ?? [],
  },
...
export const TRADE_LEG_FIELDS = [
  { key: "legId", label: "Leg ID", type: "input" },
  {
    ...
    label: "Leg Type",
    type: "dropdown",
    options: () => staticStore.legTypeValues ?? [],
  },
  { key: "notional", label: "Notional Amount", type: "input" },
  {
    ...
    label: "Currency",
    type: "dropdown",
    options: () => staticStore.currencyValues ?? [],
  },
  { key: "rate", label: "Fixed Rate", type: "input" },
  {
    ...
    type: "dropdown",
    options: () => staticStore.indexValues ?? [],
  },
  {
  ...
  },
  {
    ...
    label: "Pay/Rec",
    type: "dropdown",
    options: () => staticStore.payRecValues ?? [],
  },
];
