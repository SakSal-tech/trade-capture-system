...
- Add this markdown to `docs/step-3-implement-missing-functionality.md` in a feature branch and open a PR (no code changes), or
- Produce a PR with the unit/integration test skeletons and small explanation comments (still docs‑only until you lift the freeze), or
- Produce a short slide‑friendly summary version for your retrospective.
